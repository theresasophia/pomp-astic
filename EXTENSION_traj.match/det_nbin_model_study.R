...
write.table(sim_study[-1,], file = "~/Dropbox/AAPAPER/R_code/EXTENSION_traj.match/rota_study_nbin_10.txt" )
...
#plot(study)
save(study,sir_fixed_params,sim_study,file = "~/Dropbox/AAPAPER/R_code/EXTENSION_traj.match/det_nbin_model_study10.rda")
