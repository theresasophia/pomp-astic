...
help_param <- c(sir_fixed_params,mean_data)
...
params <- c(beta_ana(help_param), beta11=0.15, phi=0.1, sir_fixed_params,first_data,od=0.5)
...
sir_fixed_params <-c(sir_fixed_params,first_data)
save(sir,sir_fixed_params,sir.skel,init,sir.step, rmeas,dmeas,params,fromEst,toEst, dat,file = "det_nbin_model_data.rda")
