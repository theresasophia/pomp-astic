...
pairs(~logLik+beta3,data=subset(results_global,logLik>max(logLik)-10))
...
library("rootSolve")
int_beta3 <- sprintf("[%.3f, %.3f]", uniroot.all(uni_fun, lower=0.4, upper=0.5)[1],uniroot.all(uni_fun, lower=0.4, upper=0.425)[2])
save(int_beta3,file = "~/Dropbox/AAPAPER/R_code/traj.match/det_pois_STUDY/beta3_pois.rda")
