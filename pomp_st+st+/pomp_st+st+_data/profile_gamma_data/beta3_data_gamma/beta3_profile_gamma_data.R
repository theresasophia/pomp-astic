...
profileDesign(
  ...
  lower=c(beta1=11.2, beta2=0.2, beta11=0.145,phi=0.05,od=0.04,sigma=0.01,sir_fixed_params ),
  upper=c(beta1=12.2, beta2=0.3, beta11=0.155,phi=0.15,od=0.15,sigma=0.1,sir_fixed_params ),
  nprof=2
) -> pd_beta3
...
stew(file="gamma_profile_beta3_data-%d.rda",{
...
stew(file="gamma_profile_beta3_lik_data-%d.rda",{
