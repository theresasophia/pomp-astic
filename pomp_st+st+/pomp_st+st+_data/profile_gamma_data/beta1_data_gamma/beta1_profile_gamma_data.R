...
##PROFILE DESIGNS
profileDesign(
  beta1=seq(from=10.5,to=12.5,length=10),
  lower=c(beta2=0.2, beta3=0.4, beta11=0.14,phi=0.05,od=0.05,sigma=0.001,sir_fixed_params ),
  upper=c(beta2=0.3, beta3=0.5, beta11=0.155,phi=0.15,od=0.15,sigma=0.1,sir_fixed_params ),
  nprof=2
) -> pd_beta1
...
stew(file="gamma_profile_beta1_data-%d.rda",{
...
stew(file="gamma_profile_beta1_lik_data-%d.rda",{
