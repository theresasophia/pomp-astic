...
profileDesign(
  ...
  lower=c(beta1=11.2, beta2=0.2, beta3=0.4,phi=0.05,od=0.04,sigma=0.01,sir_fixed_params ),
  upper=c(beta1=12.2, beta2=0.3, beta3=0.5,phi=0.15,od=0.15,sigma=0.1,sir_fixed_params ),
  nprof=2
) -> pd_beta11
...
stew(file="gamma_profile_beta11_data-%d.rda",{
...
stew(file="gamma_profile_beta11_lik_data-%d.rda",{
