...
##PROFILE DESIGNS
profileDesign(
  sigma=seq(from=0.05,to=0.15,length=10),
  lower=c(beta1=11.2, beta2=0.2, beta3=0.4,beta11=0.145,od=0.04,phi=0.01,sir_fixed_params ),
  upper=c(beta1=12.2, beta2=0.3, beta3=0.5,beta11=0.155,od=0.15,phi=0.15,sir_fixed_params ),
  nprof=2
) -> pd_sigma
...
stew(file="gamma_profile_sigma_data-%d.rda",{
...
stew(file="gamma_profile_sigma_lik_data-%d.rda",{
