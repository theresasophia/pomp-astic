...
##PROFILE DESIGNS
profileDesign(
  od=seq(from=0.05,to=0.2,length=10),
  lower=c(beta1=11.2, beta2=0.2, beta3=0.4,beta11=0.145,phi=0.05,sigma=0.01,sir_fixed_params ),
  upper=c(beta1=12.2, beta2=0.3, beta3=0.5,beta11=0.155,phi=0.15,sigma=0.1,sir_fixed_params ),
  nprof=2
) -> pd_phi
...
stew(file="gamma_profile_od_data-%d.rda",{
...
stew(file="gamma_profile_od_lik_data-%d.rda",{
