...
##PROFILE DESIGNS
profileDesign(
  od=seq(from=0.22,to=0.38,length=10),
  lower=c(beta1=12.2, beta2=0.2, beta3=0.4,beta11=0.145,phi=0.05,sigma=0.01,sir_fixed_params ),
  upper=c(beta1=13.2, beta2=0.3, beta3=0.5,beta11=0.165,phi=0.15,sigma=0.1,sir_fixed_params ),
  nprof=2
) -> pd_phi
...
stew(file="gamma_profile_od_study-%d.rda",{
...
stew(file="gamma_profile_od_lik_study-%d.rda",{
...
lambda_spacetime <- 1 
spacetime_mcap_beta <- mcap(lp=results$logLik,parameter=results$od,lambda=lambda_spacetime)
