...
##PROFILE DESIGNS
profileDesign(
  phi=seq(from=0.05,to=0.2,length=15),
  lower=c(beta1=12.2, beta2=0.2, beta3=0.4,beta11=0.145,od=0.44,sigma=0.01,sir_fixed_params ),
  upper=c(beta1=13.2, beta2=0.3, beta3=0.5,beta11=0.165,od=0.55,sigma=0.1,sir_fixed_params ),
  nprof=2
) -> pd_phi
...
stew(file="gamma_profile_phi_studylo-%d.rda",{
...
stew(file="gamma_profile_phi_lik_studylo-%d.rda",{
